...
export function EmissionOverview({ data }) {
  ...
  const totalDaily = Number(data.total_emissions ?? data.total_emissions_kg ?? data.total_emissions_daily ?? 0);
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <MetricCard
        ...
        value={totalDaily.toLocaleString(undefined, { maximumFractionDigits: 1 })}
        unit="kgCO₂e / day"
      ...
      <MetricCard
        ...
        value={totalAnnual.toLocaleString(undefined, { maximumFractionDigits: 1 })}
        unit="tCO₂e / year"
      ...
      <MetricCard
        ...
        value={intensity > 0 ? intensity.toFixed(2) : '0.0'}
        unit="kgCO₂e / metric ton"
        subtext="Calculated per unit output"
        delta={intensity > 0 ? `${intensity.toFixed(2)} kg/t` : null}
        deltaType="neutral"
      ...
      <MetricCard
        ...
        value={production.toLocaleString(undefined, { maximumFractionDigits: 1 })}
